...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("roma-e-solidus"))
        return false;
...
{
    // Convert roma-e-solidus:// to roma-e-solidus:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("roma-e-solidus://"))
    {
        uri.replace(0, 12, "roma-e-solidus:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Roma-E-Solidus.lnk";
}
...
{
    return GetAutostartDir() / "roma-e-solidus.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Name=Roma-E-Solidus\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Roma-E-Solidus-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  roma-e-solidus-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Roma-E-Solidus-Qt"));
...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QPushButton    { background: rgb(241,135,31); color: rgb(21,21,21); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(241,135,31); border-left-style: solid; border-left-width: 6px; }"
