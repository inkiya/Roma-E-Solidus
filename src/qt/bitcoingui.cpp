...
{
    resize(850+95, 550);
    setWindowTitle(tr("Roma E-Solidus") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Roma-E-Solidus address"));
    ...
    aboutAction = new QAction(tr("&About Roma-E-Solidus"), this);
    aboutAction->setToolTip(tr("Show information about Roma-E-Solidus"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Roma-E-Solidus"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Roma-E-Solidus client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Roma-E-Solidus client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Roma-E-Solidus network", "", count));
}
...
{
    QString strTitle = tr("Roma-E-Solidus") + " - ";
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    ...
    QString strMessage = tr("There is a transaction fee of %1, "
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Roma-E-Solidus address or malformed URI parameters."));
    }
