...
const string strMessageMagic = "Roma-E-Solidus Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 40000000 * COIN;   //40M Premine 
    }
        else
    {
        nSubsidy = 40 * COIN;
...
{   
	...
	if(pindexLast->nHeight < NEW_TARGET_SPACING_2){
		nTargetSpacing = 60; //60s
	}else{
	...
	if(pindexLast->nHeight > NEW_TARGET_SPACING_2 + 1) {
...
{
    RenameThread("Roma-E-Solidus-loadblk");
