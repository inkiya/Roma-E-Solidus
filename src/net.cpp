...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Roma-E-Solidus " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node1.roma-e-solidus.eu", "node1.roma-e-solidus.eu"},
    {"node2.roma-e-solidus.eu", "node2.roma-e-solidus.eu"},
    {"node3.roma-e-solidus.eu", "node3.roma-e-solidus.eu"},
    {"node4.roma-e-solidus.eu", "node4.roma-e-solidus.eu"},
    {"node5.roma-e-solidus.eu", "node5.roma-e-solidus.eu"},
    {"node6.roma-e-solidus.eu", "node6.roma-e-solidus.eu"},
    {"node7.roma-e-solidus.eu", "node7.roma-e-solidus.eu"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Roma-E-Solidus is probably already running."), addrBind.ToString());
        else
